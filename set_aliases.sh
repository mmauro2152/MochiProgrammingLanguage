alias compile='g++ -fdiagnostics-color=always -g VarTable.cpp FuncDir.cpp MochiLexer/MochiLexer.yy.cpp MochiParser/MochiParser.tab.cpp main.cpp -o mochi.exe'
