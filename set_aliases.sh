alias compile='g++ -fdiagnostics-color=always -g src/SemanticCube.cpp src/VarTable.cpp src/FuncDir.cpp src/MochiLexer/MochiLexer.yy.cpp src/MochiParser/MochiParser.tab.cpp src/main.cpp -o mochi.exe'
